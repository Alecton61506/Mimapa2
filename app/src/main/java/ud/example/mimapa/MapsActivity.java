...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener{
    ...
    public void IrUD(View v){
        LatLng UD = new LatLng(4.5794549, -74.1575107);
        Marker miMarker=mMap.addMarker(new MarkerOptions()
        .position(UD)
        .title("La Tecno")
        .snippet("Universidad Distrital <3")
        );
    ...
    public void Micasa(View v){ //Metodo de prueba
        LatLng Mh = new LatLng(4.584721, -74.1284967);
        Marker miMarker=mMap.addMarker(new MarkerOptions()
                .position(Mh)
                .title("Mi Casa :)")
                .snippet("Mi casa - Bogota_City")
        );
        miMarker.showInfoWindow();
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(Mh, 15));
    }
